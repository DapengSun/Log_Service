...
class ConsumerRebalanceListener(object):
    ...
    This is applicable when the consumer is having KafkaOper auto-manage group
    ...
    When KafkaOper is managing the group membership, a partition re-assignment will
    ...
    def on_partitions_revoked(self, revoked):
        ...
        should be committed in this callback to either KafkaOper or a custom offset
