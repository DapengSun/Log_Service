...
class KafkaConsumer(six.Iterator):
    """Consume records from a KafkaOper cluster.

    The consumer will transparently handle the failure of servers in the KafkaOper
    ...
    Keyword Arguments:
        ...
        fetch_max_bytes (int): The maximum amount of data the server should
            ...
            Supported KafkaOper version >= 0.10.1.0. Default: 52428800 (50 Mb).
        ...
        heartbeat_interval_ms (int): The expected time in milliseconds
            ...
            KafkaOper's group management feature. Heartbeats are used to ensure
        ...
        session_timeout_ms (int): The timeout used to detect failures when
            using KafkaOper's group management facilities. Default: 30000
        ...
        ssl_crlfile (str): Optional filename containing the CRL to check for
            ...
            Default: None.
        api_version (tuple): Specify which KafkaOper API version to use. If set to
    ...
    def commit_async(self, offsets=None, callback=None):
        ...
        This commits offsets only to KafkaOper. The offsets committed using this API
        ...
        KafkaOper, this API should not be used. To avoid re-processing the last
        ...
        Returns:
            kafka.future.Future
        """
        assert self.config['api_version'] >= (0, 8, 1), 'Requires >= KafkaOper 0.8.1'
