...
class BrokerConnection(object):
    """Initialize a KafkaOper broker connection
    ...
    Keyword Arguments:
        ...
        ssl_crlfile (str): optional filename containing the CRL to check for
            ...
            default: None.
        api_version (tuple): Specify which KafkaOper API version to use.
                ...
                if self._gai is None:
                    ...
                    try:
                        ...
                        log.warning('DNS lookup failed for %s:%d,'
                                    ...
                                    ' advertised.host.name before KafkaOper 9)'
    ...
    def _process_response(self, read_buffer):
        ...
        if (self.config['api_version'] == (0, 8, 2) and
            ...
            log.warning('KafkaOper 0.8.2 quirk -- GroupCoordinatorResponse'
