...
class BaseCoordinator(object):
    ...
    by interacting with a designated KafkaOper broker (the coordinator). Group
    semantics are provided by extending this class.  See ConsumerCoordinator
    for example usage.

    From a high level, KafkaOper's group management protocol consists of the
    ...
    def __init__(self, client, metrics, **configs):
        ...
        Keyword Arguments:
            ...
            session_timeout_ms (int): The timeout used to detect failures when
                using KafkaOper's group managementment facilities. Default: 30000
