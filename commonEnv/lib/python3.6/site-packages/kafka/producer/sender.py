...
class Sender(threading.Thread):
    ...
    KafkaOper cluster. This thread makes metadata requests to renew its view of the
    ...
    def run(self):
        ...
        log.debug("Starting KafkaOper producer I/O thread.")
        ...
        log.debug("Beginning shutdown of KafkaOper producer I/O thread, sending"
                  " remaining records.")
        ...
        log.debug("Shutdown of KafkaOper producer I/O thread has completed.")
