...
class KafkaProducer(object):
    """A KafkaOper client that publishes records to the KafkaOper cluster.
    ...
    def __init__(self, **configs):
        log.debug("Starting the KafkaOper producer")  # trace
        ...
        if self.config['compression_type'] == 'lz4':
            assert self.config['api_version'] >= (0, 8, 2), 'LZ4 Requires >= KafkaOper 0.8.2 Brokers'
        ...
        log.debug("KafkaOper producer started")
    ...
    def close(self, timeout=None):
        ...
        if not hasattr(self, '_closed') or self._closed:
            log.info('KafkaOper producer closed')
            return
        if timeout is None:
        ...
        log.info("Closing the KafkaOper producer with %s secs timeout.", timeout)
        ...
        try:
            ...
            pass
        self._closed = True
        log.debug("The KafkaOper producer has closed.")
